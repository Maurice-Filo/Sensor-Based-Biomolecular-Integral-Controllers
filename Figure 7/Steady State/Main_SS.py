...
from Modules import Visualize_RPA1
from Modules import Visualize_RPA2
...
Figure_OL, Axis_OL = Visualize_RPA1(Input_OL, OL, OL_aTc, Color_Undisturbed[0], Color_Disturbed[0], Width, Title='', Settings=Plot_Settings, Normalize=False, XLabels=False, Axis=None)
Axis_OL.set_xticklabels(['Open Loop 2 \n Weak Promoter', 'Open Loop 1 \n Weak Promoter', 'Open Loop 2 \n Strong Promoter', 'Open Loop 1 \n Strong Promoter'])
...
Figure_P, Axis_P = Visualize_RPA2(Input, P_Strong, P_Strong_aTc, P_Weak, P_Weak_aTc, Color_Undisturbed, Color_Disturbed, Width, Title='P Control', Legend=Legend, Settings=Plot_Settings, Normalize=False, XLabels=True, Axis=None)

# PI
Figure_PI, Axis_PI = Visualize_RPA2(Input, PI_Strong, PI_Strong_aTc, PI_Weak, PI_Weak_aTc, Color_Undisturbed, Color_Disturbed, Width, Title='sAIF Control', Legend=Legend, Settings=Plot_Settings, Normalize=False, XLabels=True, Axis=None)

# OL Sorted
Width = 0.1
Threshold = 55
Plot_Settings['FigureSize'] = (8,4)
Figure_OL_Sorted, Axis_OL_Sorted = Visualize_RPA1_Sorted(Threshold, Input_OL, OL, OL_aTc, Color_Undisturbed, Color_Disturbed, Width, Title='', Legend=Legend, Settings=Plot_Settings, Normalize=True, XLabels=False, Axis=None)
# Axis_OL_Sorted.set_xticklabels(['OL 1', 'OL 2', 'OL 1', 'OL 2'])

# P Filtered and Sorted
Width = 0.3
Plot_Settings['FigureSize'] = (8,5.2)
Plot_Settings['YLimits'] = (0,1.4)
Figure_P_Sorted, Axis_P_Sorted = Visualize_RPA2_Sorted(Threshold, Input, Input, P_Strong, P_Strong_aTc, P_Weak, P_Weak_aTc, Color_Undisturbed, Color_Disturbed, Width, Title='', Legend=Legend, Settings=Plot_Settings, Normalize=True, XLabels=True, Axis=None)

# PI Filtered and Sorted
Figure_PI_Sorted, Axis_PI_Sorted = Visualize_RPA2_Sorted(Threshold, Input, Input, PI_Strong, PI_Strong_aTc, PI_Weak, PI_Weak_aTc, Color_Undisturbed, Color_Disturbed, Width, Title='', Legend=Legend, Settings=Plot_Settings, Normalize=True, XLabels=True, Axis=None)
plt.show()

# Save the Figures to PDF Files
Save_Flag = False
Axis_OL.set_position(Axis_P.get_position())
if Save_Flag:
    Figure_OL.savefig("RPA_OL.pdf")
    Figure_P.savefig("RPA_P.pdf")
    Figure_PI.savefig("RPA_PI.pdf")
