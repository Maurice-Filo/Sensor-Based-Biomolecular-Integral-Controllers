...
StoichiometryMatrix = StoichiometryMatrix_FP_TwoSpecies();
PropensityFunction = @PropensityFunction_FP_TwoSpecies;
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'FP_TwoSpecies_widedelta_theta');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end