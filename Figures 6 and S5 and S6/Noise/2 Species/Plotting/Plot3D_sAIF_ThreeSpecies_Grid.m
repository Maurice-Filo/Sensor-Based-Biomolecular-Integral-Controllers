...
Data_sAIF_mu_1 = load('sAIF_ThreeSpecies_delta_theta_eta_mu1.mat');
...
for i = 1 : N_mu_sAIF
    Data_sAIF_mu_i = load(['sAIF_ThreeSpecies_delta_theta_eta_mu', num2str(i), '.mat']);
...
Data_FP = load('FP_ThreeSpecies_delta_theta.mat');
...
Data_FP_Hightheta = load('FP_ThreeSpecies_FixedHightheta.mat');
...
%% Set Figure 1
Figure1_Name = 'sAIF_ThreeSpecies_delta_theta_eta_mu_NoColor';
