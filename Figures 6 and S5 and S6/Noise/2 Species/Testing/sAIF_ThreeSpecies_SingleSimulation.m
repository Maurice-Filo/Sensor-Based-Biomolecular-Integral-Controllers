...
ProjectPath = '/Users/mfilo/Library/CloudStorage/GoogleDrive-maurice.g.filo@gmail.com/My Drive/Research at ETH/My Papers and Presentations/Bacterial PI/Matlab/Noise/Fine Exhaustive Code Three Species/Testing';
DataPath = fullfile(ProjectPath, 'Data');
addpath(genpath(ProjectPath));

%% Network Construction
StoichiometryMatrix = StoichiometryMatrix_sAIF_ThreeSpecies();
PropensityFunction = @PropensityFunction_sAIF_ThreeSpecies;
Parameters = Parameters_sAIF_ThreeSpecies();
Output_Index = 3;
