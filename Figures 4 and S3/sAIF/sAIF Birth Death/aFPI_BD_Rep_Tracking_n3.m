...
N = 1000;
N_Nominal = 4;
a_Sweep = linspace(0.7*Parameters.gamma_1, 3*Parameters.gamma_1, N);
a_Sweep = a_Sweep(1:end); % to avoid numerical error when a very close to gamma_1/2
...
%% Set Figure 1
Figure1_Name = 'FPI_Rep_BD_Poles_n3';
...
%% Set Figure 2
Figure2_Name = 'FPI_Rep_BD_Gains_n3';
...
%% Set Figure 3
Figure3_Name = 'FPI_Rep_BD_BioParameters_n3';
...
%% Set Figure 4
Figure4_Name = 'FPI_Rep_BD_Simulations_n3';
...
% xline(Handle_Axis1, -Parameters.gamma_1*0.6667, 'LineWidth', LineWidth_Thin, 'Color', 'k', 'LineStyle', '--');
% xline(Handle_Axis1, -Parameters.gamma_1*3.1022, 'LineWidth', LineWidth_Thin, 'Color', 'k', 'LineStyle', '--');
...
disp(BioParameters_Nominal{1})
disp(BioParameters_Nominal{end})
