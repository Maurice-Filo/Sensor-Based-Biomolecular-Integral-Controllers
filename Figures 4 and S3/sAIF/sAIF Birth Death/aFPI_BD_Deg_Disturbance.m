...
%% Disturbance
Factor_Disturbed = 1/2;
Parameters_New = Parameters;
Parameters_New.gamma_1 = Parameters.gamma_1 * Factor_Disturbed;
...
N = 1000;
N_Nominal = 4;
a_Sweep = linspace(1.2*Parameters.gamma_1/2, 5, N+1);
...
for i = 1 : N
    ...
    [BioParameters{i}, Feasibility_Flag(i)] = Gains2Params(Gains{i}, Parameters_New, r, SupportingInput);
...
for i = 1 : N_Nominal
    ...
    Parameters.gamma_1 = Parameters.gamma_1 / Factor_Disturbed;
...
Handle_Axis2 = axes(Handle_Figure2);
    ...
    Handle_Axis2.ZLabel.String = '$\omega_c$';
    ...
    Handle_Axis2.XTick = [0, 2, 4];
    Handle_Axis2.YTick = [0, 4, 8];
...
Handle_Axis3 = axes(Handle_Figure3);
    Handle_Axis3.Position = [0.15, 0.13, 0.68, 0.78];
    Handle_Axis3.Box = 'on';
...
Handle_Axis4 = axes(Handle_Figure4);
    ...
    Handle_Axis4.XLabel.String = 'Time, t';
    Handle_Axis4.YLabel.String = 'Output';
    Handle_Axis4.YLim = [0.9*r, 1.6*r];
