...
StoichiometryMatrix = StoichiometryMatrix_FP_GeneExp();
PropensityFunction = @PropensityFunction_FP_GeneExp;
Parameters = Parameters_FP_GeneExp();
Output_Index = 2;
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'FP_GeneExp_delta');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end