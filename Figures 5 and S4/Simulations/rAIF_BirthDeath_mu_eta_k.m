...
StoichiometryMatrix = StoichiometryMatrix_rAIF_BirthDeath();
PropensityFunction = @PropensityFunction_rAIF_BirthDeath;
Parameters = Parameters_rAIF_BirthDeath();
Output_Index = 1;
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'rAIF_BirthDeath_mu_eta_k');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end