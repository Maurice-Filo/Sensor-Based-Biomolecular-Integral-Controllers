...
StoichiometryMatrix = StoichiometryMatrix_sAIF_GeneExp();
PropensityFunction = @PropensityFunction_sAIF_GeneExp;
Parameters = Parameters_sAIF_GeneExp();
Output_Index = 2;
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'sAIF_GeneExp_mu_eta');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end