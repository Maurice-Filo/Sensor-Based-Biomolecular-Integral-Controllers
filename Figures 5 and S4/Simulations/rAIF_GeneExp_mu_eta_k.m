...
StoichiometryMatrix = StoichiometryMatrix_rAIF_GeneExp();
PropensityFunction = @PropensityFunction_rAIF_GeneExp;
Parameters = Parameters_rAIF_GeneExp();
Output_Index = 2;
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'rAIF_GeneExp_mu_eta_k');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end